...
class DetailTaskScreen extends StatefulWidget {
  ...
  const DetailTaskScreen({this.toDoTaskModel,super.key});
...
class _DetailTaskScreenState extends State<DetailTaskScreen> {
  ...
  @override
  void initState() {
    context.read<DetailTaskBloc>().add(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: BlocConsumer<DetailTaskBloc, DetailTaskStates>(
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: TextView.title(
                              text: widget.toDoTaskModel!.content!,
